"""
Django settings for notesAppV1 project.
...
SECRET_KEY = 'django-insecure-^+8$!sl%qapzd2yof1tz7kcxu65#u%$s+az_xu&-psd_)w0$=0'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                 # Get a new refresh token on every use
